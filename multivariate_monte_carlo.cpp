...
target effective sample size = 4000

phase 1: number of correlated samples = 1000, effective sample size = 632, ratio of the maximum singilar value over the minimum singular value = 4.52042
phase 2: number of correlated samples = 1000, effective sample size = 632, ratio of the maximum singilar value over the minimum singular value = 2.92027
phase 3: number of correlated samples = 3900, effective sample size = 2833

sum of effective sample sizes: 4097
multivariate PSRF: 1.03216
maximum marginal PSRF: 1.00067
===============================================================================
