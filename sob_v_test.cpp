...
--- Testing volume of V-cube3
Number type: d
Computed volume 8.53024
Expected volume = 8.80869
Relative error (expected) = 0.0316105
Relative error (exact) = 0.0662804
--- Testing volume of V-cross5
Number type: d
Computed volume 0.26739
Expected volume = 0.276845
Relative error (expected) = 0.0341541
Relative error (exact) = 0.00271106
--- Testing volume of V-simplex5
Number type: d
Computed volume 0.00876222
Expected volume = 0.00810133
Relative error (expected) = 0.0815786
Relative error (exact) = 0.051467
===============================================================================
